...
DMOTOR = {"IN1": 13, "IN2": 15, "EN": 11}

SOL = {"IN1": 18, "IN2": 16, "IN3": 37, "IN4": 24, "IN5": 35}
...
def draw_window(progress, des=None):
    ...
    if progress != 100:
        ...
        win.blit(
            description,
            (162.5 - description.get_width() / 4, 285 - description.get_height() / 2),
        )
...
def send_water(ph, progress):
    ...
    if 6.4 < ph < 8.6:
        ...
        data[
            "description"
        ] = "This water could be used for drinking or cooking purposes"
        upload(data, "results")
        solenoid3()
        ...
        data[
            "description"
        ] = "This water could be used in agricultural works. It will work as a fertilizer in acidic soil"
        upload(data, "results")
        solenoid4()
        ...
        data[
            "description"
        ] = "This water should be used in household cleaning purposes like moppingthe floor, cleaning windows, etc."
        upload(data, "results")
        solenoid5()
...
def main():
    actions = [
        (solenoid1, 11, "1st Solenoid"),
        (dropperMotor, 7, "Dropper"),
        (vibratorMotor, 20, "Mixer"),
        (inpCamera, 4, "Camera"),
        (solenoid2, 10, "2nd Solenoid"),
        (send_water, 20, ""),
    ]
